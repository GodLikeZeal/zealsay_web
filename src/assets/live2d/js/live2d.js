    ...
    (g.STATE_FIRST = "STATE_FIRST"),
      ...
      ($.load = function(t) {
        for (
          ...
          for (
            var n = i[o].group, s = n.length, _ = new Array(), a = 0;
            a < s;
            a++
          ) {
            var h = n[a],
  ...
  function(t, e, i) {
    ...
    function n(t) {
      ...
      if (
        ...
        F.setMaxScreenRect(
          M.default.VIEW_LOGICAL_MAX_LEFT,
          M.default.VIEW_LOGICAL_MAX_RIGHT,
          M.default.VIEW_LOGICAL_MAX_BOTTOM,
          M.default.VIEW_LOGICAL_MAX_TOP
        ),
    ...
    function u(t) {
      ...
      var e = D.getBoundingClientRect(),
        ...
        r = S(t.clientY - e.top),
        o = $(
          { x: e.left + e.width / 2, y: e.top + e.height * G },
          { x: t.clientX, y: t.clientY },
          e
        ),
        n = m(o.x - e.left),
        s = T(o.y - e.top);
      M.default.DEBUG_MOUSE_LOG &&
        console.log(
      ...
      !(function() {
        ...
        (e._$0s = 1),
          ...
          (e.prototype.getModelImpl = function() {
            return (
              null == this._$MT && ((this._$MT = new u()), this._$MT._$zP()),
              this._$MT
            );
          }),
          ...
          (e.prototype.getIndexArray = function(t) {
            ...
            return null != e && e.getType() == H._$wb && e instanceof ht
              ? e.getIndexArray()
              : null;
          }),
          (i.CHANNEL_COUNT = 4),
        ...
        (Lt._$ni = function(t, e, i, r, o, n, s, _, a) {
          ...
          (S._$Vr = function(t, e, i, r, o, n, s, _) {
            ...
            if (a <= 0) {
              ...
              for (
                var p = o[h[0]], f = o[h[1]], c = l[0], d = 1 - c, g = 0;
                g < $;
              ...
              for (
                var Et = 1 << a, Mt = new Float32Array(Et), It = 0;
                It < Et;
                It++
              ) {
          ...
          (O.prototype._$Q2 = function(t, e) {
            for (
              var i, r, o = this._$Ob.length, n = t._$v2(), s = 0, _ = 0;
              _ < o;
              _++
            ) {
              var a = this._$Ob[_];
                ...
                if ("#" != n)
                  if ("$" != n) {
                    if (
                      ...
                      if (_ >= 0) {
                        var a = new N();
                        x.startsWith(t, s, b._$cs)
                          ? ((a._$RP = N._$hs),
                            (a._$4P = new String(t, s, _ - s)))
                          : x.startsWith(t, s, b._$ar)
            ...
            for (
              ...
              if (a._$RP == N._$hs) {
                ...
                var u = t.getParamFloat(l),
                  ...
                  f =
                    u +
                    (p + (a._$I0[n + 1 >= h ? h - 1 : n + 1] - p) * s - u) * i;
                t.setParamFloat(l, f);
              }
            }
            n >= this._$yT &&
          ...
          (k.prototype._$7T = function(t) {
            ...
            switch (this._$_L) {
              ...
              case STATE_INTERVAL:
                this._$12 < i &&
                  ((this._$_L = Et.STATE_CLOSING), (this._$bb = i)),
                  (e = 1);
                break;
              case STATE_FIRST:
              default:
        ...
        (Et.STATE_FIRST = "STATE_FIRST"),
          ...
          (X.prototype._$Nr = function(t, e) {
            ...
            if (this._$GS._$Ur(t)) {
              ...
              if ((this._$GS._$zr(n, s, o), o <= 0)) {
                ...
                for (
                  var it = 0, rt = 0, ot = 0, nt = 0, st = 0, et = 0;
                  et < j;
                  et++
                )
                  (it += q[et] * tt[et]._$fL),
          ...
          (X.prototype._$2b = function(t, e) {
            ...
            if ((i._$hS(!0), this._$32())) {
              ...
              if (
                (i._$8r == I._$ur && (i._$8r = t.getBaseDataIndex(r)),
                i._$8r < 0)
              )
            ...
            for (
              ...
              if (a._$RP == N._$hs) {
                ...
                var u,
                  p = t.getParamIndex(l),
                  f = t.getModelContext(),
                  c = 0.4 * (f.getParamMax(p) - f.getParamMin(p)),
                  d = f.getParamFloat(p),
                  g = a._$I0[n >= h ? h - 1 : n],
            ...
            for (
              ...
              if (
                ...
                if (!m) {
                  ...
                  (p -= 0.5 * ((c = 0.5 * (M + A)) + (g = 0.5 * (M - A)))),
                    (f -= 0.5 * ((d = 0.5 * (I + w)) + (y = 0.5 * (I - w))));
                }
                if (-2 < v && v < 3 && -2 < L && L < 3)
                  if (v <= 0)
                    if (L <= 0) {
            ...
            try {
              ...
              for (
                ...
                if (
                  ...
                  var tt = a._$e0;
                  if (
                    ((tt.gl_cacheImage = tt.gl_cacheImage || {}),
                    !tt.gl_cacheImage[P])
                  ) {
                    var et = rt.createCanvas(Z - J, K - Q);
                    (st.DEBUG_DATA.LDGL_CANVAS_MB =
                      st.DEBUG_DATA.LDGL_CANVAS_MB || 0),
                  ...
                  st.IGNORE_CLIP ||
                    rt.clip(u, g, n, Y, O, D, R, F, b, C, E, M, I, A, w, x),
                    st.USE_ADJUST_TRANSLATION &&
                      ((H = 0), (W = l), (j = 0), (q = $)),
          ...
          (rt.expandClip = function(t, e, i, r, o, n, s, _, a, h) {
            ...
            return (
              null != e._$P2(N) &&
              (rt.clipWithTransform(t, N, E, M, I, A, w, x, O, D, b, C, R, F),
              !0)
            );
          }),
          ...
          (ht.prototype._$Nr = function(t, e) {
            ...
            if (
              ...
              this._$GS._$Ur(t) &&
                (H.prototype._$Nr.call(this, t, i), !i._$IS[0]))
            ) {
              var r = ht._$gT;
              (r[0] = !1),
                S._$Vr(
          ...
          (ht.prototype._$2b = function(t, e) {
            try {
              ...
              if (!i && (H.prototype._$2b.call(this, t), this._$32())) {
                ...
                if (
                  (r._$8r == H._$ur && (r._$8r = t.getBaseDataIndex(o)),
                  r._$8r < 0)
                )
          ...
          (gt.prototype.compileShader = function(t, e) {
            ...
            if (
              ...
              return (
                _._$Ji("_$L0 to compile shader : " + n), i.deleteShader(o), null
              );
            }
            return o;
          }),
        ...
        (Tt.prototype._$bT = function() {
          ...
          (Tt.prototype._$5b = function() {
            this._$zT();
            for (
              var t = this._$3L(), e = new Float64Array(t), i = 0;
              i < t;
              i++
            )
          ...
          (vt.setup = function() {
            ...
            if ((e = i.indexOf("iPhone OS ")) >= 0)
              ...
              (e = i.indexOf("Android")) >= 0
                ? ((r.os = "Android"),
                  (r._isAndroid = !0),
                  (r.version = t(i, e + "Android ".length)))
                : ((r.os = "-"), (r.version = -1));
          }),
          (window.UtSystem = A),
          (window.UtDebug = _),
    ...
    (o.prototype.createModel = function() {
      ...
      (o.prototype.tapEvent = function(t, e) {
        ...
        (a.default.hitFlag = !0),
          ...
          a.default.DEBUG_LOG &&
            console.log("tapEvent view x:" + t + " y:" + e);
        for (var i = 0; i < this.models.length; i++)
            ...
            r.loadTexture(e, o, function() {
              if (r.isTexLoaded) {
                ...
                if (null != r.modelSetting.getHitAreasCustom()) {
                  ...
                  null != n.head_x &&
                    (_.default.hit_areas_custom_head_x = n.head_x),
                    null != n.head_y &&
                      (_.default.hit_areas_custom_head_y = n.head_y),
                    null != n.body_x &&
                      (_.default.hit_areas_custom_body_x = n.body_x),
                    null != n.body_y &&
                      (_.default.hit_areas_custom_body_y = n.body_y);
                }
                for (s = 0; s < r.modelSetting.getInitParamNum(); s++)
                  r.live2DModel.setParamFloat(
                    r.modelSetting.getInitParamID(s),
                    r.modelSetting.getInitParamValue(s)
                  );
                for (
                  var s = 0;
                  s < r.modelSetting.getInitPartsVisibleNum();
                  s++
                )
                  r.live2DModel.setPartsOpacity(
                    r.modelSetting.getInitPartsVisibleID(s),
                    r.modelSetting.getInitPartsVisibleValue(s)
                  );
                r.live2DModel.saveParam(),
          ...
          "1" === e &&
            ("1" === sessionStorage.getItem("Sleepy")
              ? this.startRandomMotion(
                  _.default.MOTION_GROUP_SLEEPY,
                  _.default.PRIORITY_SLEEPY
                )
              : (this.startRandomMotion(
                  _.default.MOTION_GROUP_Talk,
            ...
            this.mainMotionManager.isFinished() &&
              "0" === e &&
              ("1" === sessionStorage.getItem("Sleepy")
                ? sessionStorage.getItem("Sleepy")
                : (this.startRandomMotion(
                    _.default.MOTION_GROUP_Reset,
                    _.default.PRIORITY_IDLE
                  ),
                  "0" === document.getElementById("live_talk").value &&
                    (document.getElementById("live_talk").value = "3"))),
      ...
      (o.prototype.startMotion = function(t, e, i) {
        ...
        if (null != r && "" != r) {
          if (i == _.default.PRIORITY_FORCE)
            ...
            return void (
              _.default.DEBUG_LOG && console.log("Motion is running.")
            );
          var o,
            n = this;
          null == this.motions[t]
